...
export class NotificationController {
  ...
  async list(req: Request, res: Response): Promise<void> {
    try {
      ...
      handleControllerError(res, error, "Erro ao buscar notificações");
    }
  }
  ...
  async markRead(req: Request, res: Response): Promise<void> {
    try {
      ...
      handleControllerError(res, error, "Erro ao marcar notificação");
    }
  }
  ...
  async markAllRead(req: Request, res: Response): Promise<void> {
    try {
      ...
      handleControllerError(res, error, "Erro ao marcar notificações");
    }
  }
  ...
  async sendAnnouncement(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (err.inner) {
        res
          .status(422)
          .json({ message: "Dados inválidos", errors: err.inner.map((e) => e.message) });
        return;
      }
      handleControllerError(res, error, "Erro ao enviar comunicado");
    }
  }
  ...
  async searchUsers(req: Request, res: Response): Promise<void> {
    try {
      ...
      handleControllerError(res, error, "Erro ao buscar usuários");
    }
  }
  ...
  async sendDirect(req: Request, res: Response): Promise<void> {
    try {
      ...
      handleControllerError(res, error, "Erro ao enviar mensagem");
    }
  }
  ...
  async delete(req: Request, res: Response): Promise<void> {
    try {
      ...
      handleControllerError(res, error, "Erro ao remover notificação");
    }
  }
}
