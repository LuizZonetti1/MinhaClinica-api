...
export class ClinicSchema {
    ...
    static create = yup.object({
        ...
        subdomain: yup
            ...
            .test('subdomain-format', 'Subdomain deve conter apenas letras minúsculas, números e hífens', function (value) {
                if (!value) return true;
                return subdomainRegex.test(value);
            })
            .test('subdomain-length', 'Subdomain deve ter entre 3 e 50 caracteres', function (value) {
                if (!value) return true;
        ...
        customDomain: yup
            ...
            .nullable()
            .transform((value) => value === "" ? null : value)
            .test('custom-domain-url', 'Domínio personalizado deve ser uma URL válida', function (value) {
                if (!value) return true;
                try {
                    new URL(value);
                    return true;
