...
async function main() {
  ...
  await prisma.clinicWorkingHours.createMany({
    data: [
      { clinicId: clinic.id, dayOfWeek: 'MONDAY', isOpen: true, openTime: '08:00', closeTime: '18:00' },
      { clinicId: clinic.id, dayOfWeek: 'TUESDAY', isOpen: true, openTime: '08:00', closeTime: '18:00' },
      { clinicId: clinic.id, dayOfWeek: 'WEDNESDAY', isOpen: true, openTime: '08:00', closeTime: '18:00' },
      { clinicId: clinic.id, dayOfWeek: 'THURSDAY', isOpen: true, openTime: '08:00', closeTime: '18:00' },
      { clinicId: clinic.id, dayOfWeek: 'FRIDAY', isOpen: true, openTime: '08:00', closeTime: '18:00' },
      { clinicId: clinic.id, dayOfWeek: 'SATURDAY', isOpen: false, openTime: '08:00', closeTime: '12:00' },
      { clinicId: clinic.id, dayOfWeek: 'SUNDAY', isOpen: false, openTime: '08:00', closeTime: '12:00' },
    ],
  });
